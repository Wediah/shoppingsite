            ...
            <div className='w-full'>
                ...
                <div className='mt-5'>
                    <form action="">
                        ...
                        <div className='relative mt-6'>
                            <input type="password" name='password' id='password' placeholder='Password' className='peer border-gray-300 px-0 py-1 placeholder:text-transparent focus:border-gray-500m focus:outline-none' />
